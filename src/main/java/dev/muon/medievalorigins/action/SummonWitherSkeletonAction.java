...
public class SummonWitherSkeletonAction {
    ...
    public static void action(SerializableData.Instance data, Entity caster) {
        ...
        EntityType<?> entityType = ModEntities.SUMMON_WITHER_SKELETON;
        ...
        SummonedWitherSkeleton summon = (SummonedWitherSkeleton) entityToSpawn;
    ...
    public static ActionFactory<Entity> getFactory() {
        return new ActionFactory<>(
                ...
                SummonWitherSkeletonAction::action
        );
    }
