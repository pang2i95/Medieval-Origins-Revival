...
import net.itsparkielad.medievalorigins.powers.WingsPower;
...
public class IcarusOrigins {
    public static final PowerFactory<Power> WINGS_FACTORY = new PowerFactory<>(new Identifier(MedievalOrigins.MOD_ID, "wings"), new SerializableData()
    ...
    public static final PowerType<Power> WINGS_POWER = new PowerTypeReference<>(new Identifier(MedievalOrigins.MOD_ID, "wings"));
