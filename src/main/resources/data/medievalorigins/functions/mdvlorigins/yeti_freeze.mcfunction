...
execute at @e[tag=MedievaloriginsYetiFrozen,distance=..12] run summon minecraft:area_effect_cloud ~ ~ ~ {Duration:120,Tags:["FreezeCentre"]}
...
execute as @e[tag=MedievaloriginsYetiFrozen,distance=..12] run power grant @s medievalorigins:yeti/frozen_entity apoli:command
execute as @e[tag=FreezeCentre,distance=..12] run power grant @s medievalorigins:yeti/frozen_entity apoli:command
