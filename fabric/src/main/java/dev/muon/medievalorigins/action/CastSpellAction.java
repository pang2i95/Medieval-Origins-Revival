...
public class CastSpellAction {
    public static void action(SerializableData.Instance data, Entity entity) {
        if (entity instanceof Player) {
            ...
            SpellHelper.attemptCasting(player, itemStack, spellId, requireAmmo);

            if (entity instanceof ServerPlayer) {
                List<Entity> targets = switch (targetType) {
                    case "area" -> TargetHelper.targetsFromArea(player, range, new Spell.Release.Target.Area(), e -> e instanceof LivingEntity);
                    case "raycast" -> {
                    ...
                    case "raycast_multiple" -> TargetHelper.targetsFromRaycast(player, range, e -> e instanceof LivingEntity);
                    default -> List.of();
                };
